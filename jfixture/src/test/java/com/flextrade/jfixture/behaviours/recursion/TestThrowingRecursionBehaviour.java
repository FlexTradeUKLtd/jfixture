...
public class TestThrowingRecursionBehaviour {

    private ThrowingRecursionBehaviour behaviour;
    ...
    public void initialise() {
        ...
        this.behaviour = new ThrowingRecursionBehaviour();
    }
    ...
    @Test
    public void recursion_guard_is_given_throwing_recursion_handler() {
        RecursionGuard guard = (RecursionGuard)this.behaviour.transform(this.mockSpecimenBuilder);
        assertTrue(guard.handler() instanceof ThrowingRecursionHandler);
    }
}
